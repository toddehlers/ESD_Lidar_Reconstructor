...
int main (int argc, char** argv)
{
 	...
 	pcl::PointCloud<pcl::PointXYZI>::Ptr inputGPC (new pcl::PointCloud<pcl::PointXYZI>);
	...
	mut.lock(); 
	std::cout << "Loaded "<< pcl::io::loadPCDFile<pcl::PointXYZI> (inputGPCName, *inputGPC)<<std::endl;
	mut.unlock(); 
